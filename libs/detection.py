...
Required dependencies:
    - Python3
    - YOLO Library from https://github.com/ultralytics/yolov5 
...
Usage:
    $ python path/to/detect.py --yolov5 path\\to\\yolov5_Library --source 0 --weights path/to/.pt
"""
import sys
...
class ObjectDetector:
    ...
    def run(self):
        ...
        for path, img, im0s, __videoCapture in dataset:
